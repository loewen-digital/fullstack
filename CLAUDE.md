...
Claude runs unattended via `.github/workflows/agent.yml`. Nobody answers questions. This section overrides the "Git Workflow" section above for unattended runs: the agent always works on a branch and opens a PR, never pushes to `main`.
